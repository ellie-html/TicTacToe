...
button.addEventListener("click", function () {
  body[0].style.backgroundImage = "url('https://img4.goodfon.com/wallpaper/nbig/4/b5/firewatch-campo-santo-kholmy-les-peizazh-igra-gory-pozharnyi.jpg')" 
});
...
button.addEventListener("click", function () {
  body[0].style.backgroundImage = "url('https://bestwallpapers.in/wp-content/uploads/2018/07/wolf-howling-to-moon-minimal-4k-wallpaper-2560x1440.jpg')" 
});



var button = document.getElementById("click3");
var body = document.getElementsByTagName("body");	

button.addEventListener("click", function () {
  body[0].style.backgroundImage = "url('https://images.wallpapersden.com/image/download/eagle-mountain-sunset-minimalist_63668_1920x1080.jpg')" 
});


var button = document.getElementById("click4");
var body = document.getElementsByTagName("body");	

button.addEventListener("click", function () {
  body[0].style.backgroundImage = "url('https://wallpaperboat.com/wp-content/uploads/2019/06/minimalist-desktop-14.jpg')" 
});
